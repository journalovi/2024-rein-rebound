...
In the case of REBOUND, a user simply downloads the source code and compiles it using any C compiler~[REBOUND also comes in the form of a pre-compiled Python package in which case no compiler is needed.].
