...
- After making these changes, one should be able to compile the code with emscripten and run the visualization in the browser. This is a good oportunity to fix any new bugs or rendering issues.
