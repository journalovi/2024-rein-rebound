...
The [REBOUND documentation](https://rebound.readthedocs.io/en/latest/c_examples/selfgravity_disc/) makes extensive use of the browser mode, offering users the ability to run all examples directly in the browser and thus showcasing the ability of the software package.
...
To further facilitate the rendering of complex animations, we also [implement a way](https://rebound.readthedocs.io/en/latest/c_examples/animation_solar_system/#animation-of-the-solar-system-c) for the server side to push the view matrix and other visualization setting to the browser and override any client side user interaction. 
