...
In constrast to the browser mode discussed above, with Pyodide a user can interpret python code interactively directly in the browser. 
REBOUND already is available as a Pyodide package and one can thus code up and run a custom REBOUND simulation entirely from within the broswer. 
